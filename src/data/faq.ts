...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer: '출시 후 기본 보증 기간이 포함되며, 이후 유지보수 방식은 프로젝트 성격에 맞게 상담을 통해 결정합니다. 긴급 문제가 생기면 빠르게 대응합니다.',
  },
  {
    question: '기존 시스템이 있으면 데이터 이전이 가능한가요?',
    answer: '네. 기존 시스템과 새 시스템을 함께 돌려보고, 문제 없는 걸 확인한 뒤 안전하게 전환합니다. 데이터 손실 없이 이전합니다.',
  },
  {
